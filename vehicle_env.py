...
class VehicleModelUpdateEnv:
    ...
    def __init__(self, 
        ...
        self.min_vehicles_per_round = min_vehicles_per_round
        self.max_vehicles_per_round = max_vehicles_per_round
    ...
    def get_new_vehicles(self):
        ...
        if random.random() < self.arrival_rate:
            count = random.randint(1, 5)  # Random number of new vehicles
